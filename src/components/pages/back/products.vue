    ...
    <tbody>
      <tr v-for="(item , key) in products" :key="item.id">
        ...
        <td>
          ...
          @click="openModal('preDelete',item)">刪除</button>
        </td>
      </tr>
    </tbody>
  </table>
...
<div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <div class="modal-footer">
        <button type="button" @click="openModal('cancel')" class="btn btn-outline-secondary" data-dismiss="modal">取消</button>
